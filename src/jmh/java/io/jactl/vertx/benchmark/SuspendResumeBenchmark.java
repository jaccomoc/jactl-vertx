...
public class SuspendResumeBenchmark {
  ...
  private String _runTest(int value) {
    globals.put("sleepCount", value);
    String result = (String) script.eval(globals);
    assert result.equals(expected) : "Result error: " + result;
    return result;
  }

  @Benchmark
  public Object suspend0() {
    return _runTest(0);
  }

  @Benchmark
  public Object suspend1() {
    return _runTest(1);
  }
