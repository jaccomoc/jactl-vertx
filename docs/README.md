...
```groovy
implementation group: 'io.jactl', name: 'jactl-vertx', version: '1.3.1'
```
...
```groovy
implementation group:'io.jactl', name:'jactl-vertx', version:'1.3.1', classifier:'tests'
```
...
```groovy
def VERS = '1.3.1'                                                  // The jactl-vertx version to use
...
```shell
$ java -cp jactl-vertx-1.3.1-tests.jar:jactl-vertx-1.3.1.jar io.jactl.vertx.example.ExampleWebServer
Listening on localhost:52178
```

If you pass in a port number on the command line it will use that instead:
```shell
$ java -cp jactl-vertx-1.3.1-tests.jar:jactl-vertx-1.3.1.jar io.jactl.vertx.example.ExampleWebServer 8080
