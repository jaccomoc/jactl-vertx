...
```groovy
implementation group: 'io.jactl', name: 'jactl-vertx', version: '2.9.2'
```
...
```groovy
implementation group:'io.jactl', name:'jactl-vertx', version:'2.9.2', classifier:'tests'
```
...
```groovy
def VERS = '2.9.2'                                                  // The jactl-vertx version to use
...
```shell
$ java -cp jactl-vertx-2.9.2-tests.jar:jactl-vertx-2.9.2.jar io.jactl.vertx.example.ExampleWebServer
Listening on localhost:52178
```

If you pass in a port number on the command line it will use that instead:
```shell
$ java -cp jactl-vertx-2.9.2-tests.jar:jactl-vertx-2.9.2.jar io.jactl.vertx.example.ExampleWebServer 8080
