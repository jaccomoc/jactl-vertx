...
```groovy
implementation group: 'io.jactl', name: 'jactl-vertx', version: '1.4.0'
```
...
```groovy
implementation group:'io.jactl', name:'jactl-vertx', version:'1.4.0', classifier:'tests'
```
...
```groovy
def VERS = '1.4.0'                                                  // The jactl-vertx version to use
...
```shell
$ java -cp jactl-vertx-1.4.0-tests.jar:jactl-vertx-1.4.0.jar io.jactl.vertx.example.ExampleWebServer
Listening on localhost:52178
```

If you pass in a port number on the command line it will use that instead:
```shell
$ java -cp jactl-vertx-1.4.0-tests.jar:jactl-vertx-1.4.0.jar io.jactl.vertx.example.ExampleWebServer 8080
